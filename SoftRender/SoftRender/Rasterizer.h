...
public :
	...
	void drawTriangle(Vertex & v0, Vertex & v1, Vertex & v2, SDL_Surface* screenSurface)
	{
	...
	template <class T>
	void DrawTriangleByBlock(const Vertex & v0, const Vertex & v1, const Vertex & v2) const
	{
	...
	template <class T>
	void DrawTriangleByScanLine(const Vertex & v0, const Vertex & v1, const Vertex & v2) const
	{
		TriangleEquation tri(v0, v1, v2, T::VarCount);
		//剔除背面的平面
		if (tri.area < 0)
	...
	template <class T>
	void DrawTopFlatTriangle(const TriangleEquation &eqn, const Vertex & v0, const Vertex & v1, const Vertex & v2) const
	{
	...
	template <class T>
	void DrawBottomFlatTriangle(const TriangleEquation &eqn, const Vertex & v0, const Vertex & v1, const Vertex & v2) const
	{
	...
	template <class T>
	void DrawTriangleMode(const Vertex & v0, const Vertex & v1, const Vertex & v2) const 
	{
		switch (mode)
		{
